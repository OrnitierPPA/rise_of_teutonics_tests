...
class BuildPage(BasePage):
    def build_house(self):
        ...
        assert self.is_element_present(*BuildingPageLocators.HOME_BUILD), "Кнопки покупки дома нет, либо она в недосягаемости"
    ...
    def check_house_level(self):
        ...
        assert js_house_level == 1, "Программно уровень не был повышен"
        ...
        assert button_text[2] + button_text[3] == "ур.2" or button_text[2] + button_text[3] == 'lvl2' or \
               ...
               button_text[3] + button_text[4] == 'niveau2', "Уровень не был повышен"
    ...
    def check_house_in_city(self):
        if self.element_clickable(*BasePageLocators.CITY):
            ...
            pass
        assert self.is_element_present(*CityPageLocators.HOUSE_SMOKE), "Дом не был построен"
